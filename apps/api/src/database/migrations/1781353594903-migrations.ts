...
export class Migrations1781353594903 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "document_segments" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "documentId" uuid NOT NULL, "knowledgeBaseId" character varying NOT NULL, "index" integer NOT NULL, "content" text NOT NULL, "charCount" integer NOT NULL DEFAULT '0', "tokenCount" integer, "metadata" jsonb NOT NULL DEFAULT '{}', "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "PK_dd916ea1f6baa18bcbc861eb173" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
      `ALTER TABLE "documents" ADD CONSTRAINT "FK_2cb9462c87c823404b13692946a" FOREIGN KEY ("knowledgeBaseId") REFERENCES "knowledge_bases"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`
    );
    await queryRunner.query(
      `ALTER TABLE "document_segments" ADD CONSTRAINT "FK_9371629195a4f9542e574b5b76a" FOREIGN KEY ("documentId") REFERENCES "documents"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`
    );
  }
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "documents" DROP CONSTRAINT "FK_2cb9462c87c823404b13692946a"`
    );
