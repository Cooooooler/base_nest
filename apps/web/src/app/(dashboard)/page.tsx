  ...
  return (
    <div className="space-y-6">
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        <DashboardCard title="模型提供商" value={String(providers?.length ?? '—')} description="已配置的提供商" />
        <DashboardCard title="知识库" value={String(knowledgeBases?.length ?? '—')} description="创建的知识库" />
